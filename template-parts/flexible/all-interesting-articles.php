<section class="all">
    <div class="container">
        ...
        <div class="all__slider swiper">
            <div class="all__wrapper swiper-wrapper">
                <?php
                $args = array(
                    'post_type' => 'post',        // Вказуємо тип постів (зазвичай "post" для стандартних постів)
                    'posts_per_page' => -1,        // Вказуємо кількість постів, які хочемо вивести
                );
                ...
                if ($posts_query->have_posts()) {
                    while ($posts_query->have_posts()) {
                        ...
                        ?>
                        <a href="<?php the_permalink(); ?>" class="all__slide swiper-slide">
        ...
        <div class="all__pagination swiper-pagination"></div>
    </div>
</section>