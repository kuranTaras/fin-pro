<section class="reviews reviews-small" id="reviews">
    <div class="container">
        ...
        <div class="reviews__slider swiper blur">
            <div class="reviews__wrapper swiper-wrapper">
                ...
                $comments_args = array(
                    'post_id' => get_the_ID(), // Отримуємо ID поточного поста
                    'status' => 'approve',
                    'number' => 8// Вибираємо тільки схвалені коментарі
                );
        ...
        <a href="<?php echo substr(get_permalink(), 0, -1)?>-reviews/#reviews" class="reviews-btn btn-blue">
            <span>
                <?php the_sub_field('add_review_button'); ?>
            </span>
        </a>
    </div>
</section>